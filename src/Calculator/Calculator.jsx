  ...
  const handleClick = (btnvalue) => {
    if (btnvalue === "C") {
      ...
      try {
        ...
        const finalres =
          input1 % 1 === 0 ? input1.toString() : input1.toFixed(3);
        setResult(finalres);
        setInput(finalres);
  ...
  return (
    <div className="mainContainer">
      <div className="calculator">
        <div className="OutputScreen" data-testid="OutputScreen">
      ...
      <div className="HistoryTab">
        ...
        <div className="historyCardContainer" style={{ flex: 1 }}>
          {" "}
